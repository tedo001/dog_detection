"""
Dog Aggression Detection — native desktop app (PyQt6 edition, app4.py).
...
app4 is self-contained: it reuses the existing DogAggressionPipeline
...
def setup_logging(bridge):
    ...
    logger = logging.getLogger("dogaggression_app4")
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Dog Aggression Detection — Desktop (app4)")
